...
var worker = new Worker('/js/float_font.js');
...
function initText() {
    ffText.setTextAnimate($('.tip-text'    ), -1   ,3    );
    ffText.setTextAnimate($('.wang-text'    ), 50   ,100    );
    ffText.setTextAnimate($('.miao-text-1'  ), 120  ,140    );
    ffText.setTextAnimate($('.miao-text-2'  ), 147  ,219    );
    ffText.setTextAnimate($('.fu-text-1'    ), 406  ,479    );
    ffText.setTextAnimate($('.fu-text-2'    ), 493  ,513    );
    ffText.setTextAnimate($('.yu-text-1'    ), 669  ,738    );
    ...
    ffText.setTextAnimate($('.shen-text'    ), 1515 ,1550   );
    ffText.setTextAnimate($('.yi-text'      ), 1655 ,1689   );
    ffText.setTextAnimate($('.long-text'    ), 1749 ,1786   );
    ffText.setTextAnimate($('.jiu-text-1'   ), 1866 ,1888   );
    ffText.setTextAnimate($('.jiu-text-2'   ), 1964 ,2025   );
    ffText.setTextAnimate($('.xiao-text-1'  ), 2034 ,2080   );
    ...
    ffText.setTextAnimate($('.yin-text-1'     ), 2600 ,2723   );
    ffText.setTextAnimate($('.yin-text-2'     ), 2600 ,2723   );
...
var pageWeight = document.body.offsetWidth;
var pageHeight = document.body.offsetHeight;
if( (pageWeight / pageHeight) > (640/1236) ){
    startBgH = pageHeight;
    startBgW = (640/1236)*pageHeight;
}else{
    startBgH = (1236/640)*pageWeight;
    startBgW = pageWeight;
}
$('#startBg').css('height',startBgH);
$('#startBg').css('width',startBgW);
$('#startBg').css('margin-left',-startBgW/2);
$('#startBg').css('margin-top',-startBgH/2);
console.log(1)
